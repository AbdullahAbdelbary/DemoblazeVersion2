...
public class HomePageHeba extends BasePage {
    private static By phonesCategory = By.xpath("//a[contains(text(),'Phones')]");
    private static By laptopsCategory = By.xpath("//a[contains(text(),'Laptops')]");
    private static By monitorsCategory = By.xpath("//a[contains(text(),'Monitors')]");
    ...
    public HomePageHeba(WebDriver driver) {
